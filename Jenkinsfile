  ...
  stages {
    ...
    stage('Code Analysis') {
      ...
      stage('Slack Notification') {
        steps {
          slackSend(baseUrl: 'https://hooks.slack.com/services/', token: 'T01N51K5L01/B01SK5ZK7HT/8g4ZsGtZIBvn64iN5jzsefbu', attachments: '"hello"', blocks: '"block"', channel: '"tpGradle"', message: '"deployment finished"', teamDomain: '"tpgradle-workspace.slack.com"')
        }
      }
